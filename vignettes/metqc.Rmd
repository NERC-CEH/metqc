...
## metqc app
The metqc app allows the user to manually check the variables in a chosen data range, select any dubious values, and provide replacement values by several methods.
TBC
